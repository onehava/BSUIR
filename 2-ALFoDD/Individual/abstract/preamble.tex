...
\captionsetup[figure]{labelformat=stbfigure, justification=centering, labelsep=stb, size=small} % Специфическое требование кафедры
...
\newlength{\eqindent}
\setlength{\eqindent}{1.4em} % Reccomended: baselineskip, 1.3em, 1.4em, 1.5em
